...
// import "./App.css";
// import Box from "./ReactComponent/box";
// const Render_from = [
//   [1, 2, 3], [4, 5, 6], [7, 8, 9]
// ];

// function App() {
//   const [gameState, setGameState] = useState(Render_from);
//   const [curruntPlayer, setCurruntPlayer] = useState('circle')
...
//       ) {
//         setFinishState([row * 3 + 0, row * 3 + 1, row * 3 + 2]);
...
//       ) {
//         setFinishState([0 * 3 + col, 1 * 3 + col, 2 * 3 + col]);
...
//               return <Box
//                 curruntPlayer={curruntPlayer}
//                 setCurruntPlayer={setCurruntPlayer}
...
//       </div>
//       {/* {finishState &&
//         finishState !== "opponentLeftMatch" &&
//         finishState !== "draw" && (
//           <h3 className="finished-state">
//             {finishState === playingAs ? "You " : finishState} won the
//             game
//           </h3>
//         )}
//       {finishState &&
